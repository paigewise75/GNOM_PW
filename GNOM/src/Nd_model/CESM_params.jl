...
p = Params(
    ...
    ε_NWAf_dust = -11.595per10000, # -12.3per10000
    ...
    β_EAsia_dust = 2.00per100, # 23.0per100
    β_NEAf_dust = 2.00per100, # 23.3per100
    β_NWAf_dust = 2.00per100, # 3.17per100
    β_NAm_dust = 2.00per100, # 82.8per100
    β_SAf_dust = 2.00per100, # 38.5per100
    β_SAm_dust = 2.00per100, # 2.52per100
    β_MECA_dust = 2.00per100, # 14.7per100
    β_Aus_dust = 2.00per100, # 11.6per100
    β_Sahel_dust = 2.00per100, # 2.95per100
